 ...
 * @LastEditTime: 2020-12-15 14:28:32
...
<template>
    <div class="page">
        <div class="width_90 margin_auto margin_top_20">
            <div v-if="this_step == 'select_template'">
                ...
                <div class="display_flex flex_jusify_space wrop">
                    ...
                    >
                        ...
                        >
                            <img :src="item.img_cp" alt class="width_100" />
                        </div>
            ...
            <div v-else-if="this_step == 'upload_img_and_title'">
                ...
                <div class="margin_top_10">
                    <el-button @click="init()" class="width_100" type="primary"
                        >确认模板</el-button
                    >
                </div>
                <div
                    class="overflow_hidden overbox margin_bottom_20"
                    style
                >
                    <div
                        :class="getThisName"
                    ...
                    >
                        ...
                        <span
                            ...
                            class="time_desc display_inline_block lh20 text_center"
                            >{{ time_desc }}</span
                        >
                        <span
                            :style="{
                        ...
                        <span
                            ...
                            "
                            :class="{
                                notransform: selected_index == '2',
                                lh23: selected_index == 0,
                                lh26: selected_index == 2,
                            }"
                            :style="{
                                left:
                                    template_img_list[selected_index]
                            ...
                            class="price_desc display_inline_block"
                        >
                        </span>
                        <!-- <span
            ...
            <div v-else-if="this_step == 'tocanvas'">
                ...
                <div class="text_center">
                    <img alt class="width_70" id="img" src />
                </div>
            </div>
            <el-button
                @click="beforeStep()"
        ...
        <div class="cropper" v-show="showWin">
            <vueCropper
                :autoCropHeight="250"
                :autoCropWidth="250"
                :img="imageUrl"
            ...
            ></vueCropper>
            <div class="op">
                <span @click="clickHandler(1)">裁剪</span>
                <span @click="clickHandler(2)">放大</span>
                <span @click="clickHandler(3)">缩小</span>
            </div>
        </div>
    </div>
</template>
...
export default {
        ...
        return {
            ...
            template_img_list: [
                ...
                },
                {
                    ...
                    price_type_left: "416px",
                    price_type_top: "455px",
                },
                {
                    name: "模板C",
    ...
    methods: {
        ...
        blurAddr() {
            this.transform_left =
                parseInt(
                    getComputedStyle(document.querySelector(".space_name"))
                        .width
                ) / 2;
        },
        back() {
